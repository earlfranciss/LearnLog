...
public class TableCustom extends JTable {
    ...
    public void fixTable(JScrollPane scroll) {
        ...
        scroll.getViewport().setBackground(new Color(0, 31, 63));
    ...
    private class TableHeader extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable jtable, Object o, boolean bln, boolean bln1, int i, int i1) {
            ...
            com.setBackground(new Color(0, 31, 63));
    ...
    private class TableCell extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable jtable, Object o, boolean bln, boolean bln1, int row, int column) {
            ...
            if (isCellSelected(row, column)) {
                ...
                if (row % 2 == 0) {
                    com.setBackground(new Color(0, 31, 63, 130));
                } else {
                    com.setBackground(new Color(0, 31, 63, 150));
                }
            }
